...
export default function ViewCustomerModal() {
  ...
  const customer = {
    ...
    contactAddressField2: '1600 Amphitheatre Parkway',
    contactAddressField3: '1600 Amphitheatre Parkway',
    ...
    billingAddressField2: '1600 Amphitheatre Parkway',
    billingAddressField3: '1600 Amphitheatre Parkway',
