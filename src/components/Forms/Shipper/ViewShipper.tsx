...
// this component displays information about a specific shipper

interface ViewShipperProps {
  data: ShipperData | undefined;
}

const ViewShipperForm = ({ data }: ViewShipperProps) => {
        ...
        <div className="grow overflow-auto">
          <div className="flex flex-col gap-4 md:flex-row">
            ...
            <div className="flex flex-col w-full">
              <DataDisplay title="Shipper Name" text={data['name']} />
            </div>
          </div>
...
export default ViewShipperForm;
